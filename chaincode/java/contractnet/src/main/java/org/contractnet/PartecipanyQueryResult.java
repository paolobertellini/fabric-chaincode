 ...
 */
@DataType()
public final class PartecipanyQueryResult {
    @Property()
    ...
    public PartecipanyQueryResult(@JsonProperty("Key") final String key, @JsonProperty("Record") final Partecipant record) {
        this.key = key;
        this.record = record;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        PartecipanyQueryResult other = (PartecipanyQueryResult) obj;
